...
void process_csv_files() {
    ...
    double h_min = *std::min_element(filtered_amplitude.begin(), filtered_amplitude.end());
    double h_max = *std::max_element(filtered_amplitude.begin(), filtered_amplitude.end());
    
    TH1F* hist = new TH1F("hist_amplitude", "Filtered Amplitude Distribution;Amplitude;Counts", 100, h_min, h_max);
